...
const mobileClubListIndex = exploreView.indexOf('data-mobile-club-list-priority="true"');
const mobileMapIndex = exploreView.indexOf('data-mobile-list-map-container="true"');
assert.ok(mobileClubListIndex >= 0, 'Mobile list view must expose an explicit club-first discovery block.');
