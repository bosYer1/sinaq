...
assert(exploreView.includes("searchActive ? 'h-[220px] sm:h-[280px]' : 'h-[300px] sm:h-[360px]'"), 'Mobile discovery must keep map-first while exposing club cards sooner, with an even more compact search state.');
