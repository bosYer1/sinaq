...
assert.ok(layout.includes("viewportFit: 'cover'"), 'Root layout must opt into iOS edge-to-edge viewport behavior.');
assert.ok(mobileNav.includes('pb-[env(safe-area-inset-bottom)]'), 'Mobile nav must preserve safe-area padding when viewport-fit=cover is enabled.');
