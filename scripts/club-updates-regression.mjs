...
const checks = [
  ...
  [feed.includes('snap-x snap-mandatory'), 'mobile home preview renders the offer cards as a swipeable row'],
  [feed.includes('overflow-x-auto'), 'mobile users can reach every bounded offer card'],
  ...
  [home.includes('activeUpdates.slice(0, 3)'), 'home keeps a bounded three-item update preview across breakpoints'],
