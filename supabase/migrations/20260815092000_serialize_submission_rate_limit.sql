...
begin
  ...
  -- Serialize checks for the same normalized contact inside the transaction.
  -- Without this lock, simultaneous inserts could all observe a count below
  -- the limit and collectively exceed the 3-per-15-minute threshold.
