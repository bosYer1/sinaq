...
const contentSecurityPolicy = [
  ...
  "frame-src 'none'",
  "object-src 'none'",
  "script-src 'self' 'unsafe-inline' https://connect.facebook.net https://www.googletagmanager.com https://us-assets.i.posthog.com",
  "script-src-attr 'none'",
  "style-src 'self' 'unsafe-inline'",
  "img-src 'self' data: blob: https://uxcedpbumulpheglhlvs.supabase.co https://tile.openstreetmap.org https://marsol.az https://www.facebook.com",
  "font-src 'self' data:",
  "connect-src 'self' https://uxcedpbumulpheglhlvs.supabase.co wss://uxcedpbumulpheglhlvs.supabase.co https://www.facebook.com https://www.google-analytics.com https://region1.google-analytics.com https://us.i.posthog.com",
  "media-src 'self'",
