...
export function SearchFilter() {
  ...
  return <div className="relative w-full">
    ...
    <input type="search" value={value} onChange={(event) => setValue(event.target.value)} placeholder="Klub, rayon və ya ünvan axtar..." aria-label="Klub adı və ya ünvan üzrə axtar" enterKeyHint="search" autoComplete="off" className="h-12 w-full rounded-2xl border border-white/10 bg-white/[.045] pl-12 pr-11 text-sm font-medium text-white shadow-[inset_0_1px_rgba(255,255,255,.025)] outline-none transition placeholder:font-normal placeholder:text-faint hover:border-primary/30 focus:border-primary/60 focus:bg-white/[.06] focus:ring-4 focus:ring-primary/10" />
