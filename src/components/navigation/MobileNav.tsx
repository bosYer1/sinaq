...
const baseClass = 'flex flex-col items-center justify-center gap-0.5 text-[10px] transition';
...
export function MobileNav() {
  ...
  return (
    <nav
      className="grid min-h-[58px] shrink-0 grid-cols-5 border-t border-border bg-surface px-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_24px_rgba(31,35,48,0.06)] md:hidden"
    ...
    >
      ...
      <Link href="/#club-search" className="flex flex-col items-center justify-center gap-0.5 text-[10px] font-semibold text-primary transition">
        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-primary text-white shadow-[0_4px_12px_rgba(124,92,252,0.28)]">
