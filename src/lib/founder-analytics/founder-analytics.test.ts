...
test('CEO signal cap never hides a later critical signal behind lower-severity noise', () => {
  ...
  const posthog = {
    ...
    mapUsage: zero, phoneClicks: zero, instagramClicks: zero, tiktokClicks: zero, mapsClicks: zero, newUsers: 25,
