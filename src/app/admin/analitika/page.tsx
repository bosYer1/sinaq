  ...
  return (
    <div>
      <div className="max-w-3xl">
        ...
        <p className="mt-2 text-sm leading-6 text-gray-500">GameYer trafikini iki müstəqil mənbədən yoxla: Supabase operativ statistika və PostHog public davranış/conversion analitikası.</p>
      </div>
      ...
      <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-900"><strong>Data quality:</strong> PostHog public trafik filtri admin/API və bot/automation trafikini çıxarır. Məlum Cloud Browser test visitor-u yeni production eventlərində ayrıca bloklanır. Supabase “unikal” göstəricisi anonim sessiya ID-sidir və real şəxs sayı kimi qəbul edilmir.</div>
    </div>
  );
}
