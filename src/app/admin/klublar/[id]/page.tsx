      ...
      <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2">
            ...
            {club.is_verified ? (
              <span className="rounded-full bg-[#7C5CFC]/10 px-2.5 py-1 text-xs font-semibold text-[#6A47F0]">Verification flag aktivdir</span>
            ) : (
              <span className="rounded-full bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-600">Verification flag yoxdur</span>
            )}
          </div>
          <p className="mt-1 text-sm text-gray-500">Klubun bütün məlumatlarını bu səhifədən idarə et.</p><p className="mt-1 text-xs font-semibold text-amber-700">Verification flag təkbaşına owner/rəsmi nümayəndə təsdiqi deyil; ayrıca sübut tələb edir.</p>
        </div>
