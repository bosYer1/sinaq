        ...
        <aside className="hidden w-64 shrink-0 border-r border-gray-200 bg-white lg:block">
          <div className="sticky top-0 p-5">
            ...
            <nav className="mt-7 space-y-1 text-sm">
              <Link
                href="/admin"
                className="block rounded-lg px-3 py-2.5 font-medium text-gray-700 hover:bg-gray-100"
              >
                Dashboard
              </Link>
              ...
              <Link
                href="/"
                className="block rounded-lg px-3 py-2.5 font-medium text-gray-500 hover:bg-gray-100"
              >
                Sayta qayıt
              </Link>
            </nav>
