      ...
      <div className="mx-auto max-w-[1440px] px-4 pb-8 pt-4 sm:px-6 sm:pt-6 lg:px-8 lg:pb-10 lg:pt-8">
        ...
        <div className="flex flex-col">
          ...
          {activeUpdates.length > 0 ? (
            <section className="order-1 mb-3 sm:mb-4 sm:rounded-2xl sm:border sm:border-primary/15 sm:bg-primary/5 sm:px-5 sm:py-5" aria-label="Aktiv təkliflər və turnirlər">
