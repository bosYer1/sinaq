        ...
        <div className="mx-auto max-w-[1440px] px-4 pb-8 pt-4 sm:px-6 sm:pt-6 lg:px-8 lg:pb-10 lg:pt-8">
          <section className="mb-4 flex items-end justify-between gap-3 sm:mb-5" aria-labelledby="home-title">
            <div className="min-w-0">
              <h1 id="home-title" className="font-display text-[22px] font-bold leading-tight tracking-[-0.035em] text-ink sm:text-3xl">Bakıda PC və PlayStation klubları</h1>
              <p className="mt-1 text-xs text-muted sm:mt-1.5 sm:text-sm">Qiymət, rayon, iş saatı və xəritəyə görə gaming klubu tap.</p>
            </div>
            <div className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-[#F0ECFF] px-3 py-1.5 text-xs font-semibold text-primary sm:gap-2 sm:px-3.5 sm:py-2 sm:text-sm"><span aria-hidden="true">🎮</span>{discoveryClubs.length} klub</div>
          </section>
          ...
          <section className="mt-6 rounded-2xl border border-border bg-surface px-4 py-5 sm:px-6 lg:mt-7" aria-labelledby="discover-heading">
            ...
            <p className="mt-1 max-w-3xl text-xs leading-5 text-muted">PC klubu, kompüter klubu, PlayStation klubu, ucuz saatlıq tarif, 24 saat açıq məkan və Bakı rayonları üzrə ayrıca siyahılara keç. Qiyməti məlum klubları müqayisə etmək üçün ayrıca qiymət səhifəsindən istifadə et.</p>
          ...
          <section className="mt-4 rounded-2xl border border-border bg-white px-4 py-5 sm:px-6" aria-labelledby="seo-help-heading">
            ...
            <p className="mt-2 max-w-4xl text-xs leading-5 text-muted">Klub profilində mövcud olduqda PC və PlayStation saatlıq qiymətləri, ünvan, rayon, iş saatları, telefon, Instagram, şəkillər və xəritə koordinatları göstərilir. Məqsəd yaxın gaming klubunu tapmaq üçün fərqli sayt və sosial şəbəkələrdə ayrıca axtarış etmə ehtiyacını azaltmaqdır.</p>
          </section>
        </div>
      </div>
    </>
