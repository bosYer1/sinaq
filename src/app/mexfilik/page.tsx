    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="mt-8 space-y-7 text-sm leading-7 text-ink">
        <section>
          ...
          <p className="mt-2 text-muted">GameYer Bakıdakı PC və PlayStation klublarını tapmağı asanlaşdıran platformadır. Saytın əsas klub siyahısı və xəritəsi şəxsi hesab yaratmadan istifadə oluna bilər.</p>
        </section>
