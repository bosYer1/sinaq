...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'az_AZ',
    url: '/bakida-ucuz-playstation-klublari',
    title: 'Bakıda ucuz PlayStation klubları | GameYer',
    description: 'Saatlıq qiyməti 3 AZN-dək olan Bakı PlayStation klublarını müqayisə et.',
  },
};
...
export default async function CheapPlayStationClubsPage() {
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      {
        '@type': 'ItemList',
        name: 'Bakıda 3 AZN-dək PlayStation klubları',
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-10">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-6 text-muted">
        Saatlıq PlayStation qiyməti 3 AZN-dək olan Bakı gaming məkanlarını müqayisə et. Hazırda qiyməti təsdiqlənmiş {clubs.length} uyğun klub göstərilir. PS3, PS4, PS5 və VIP otaq tarifləri eyni klubda fərqli ola bildiyi üçün detalları klub səhifəsində yoxla.
      </p>
      <div className="mt-4 flex flex-wrap gap-2">
        <Link href="/bakida-playstation-klublari" className="rounded-control border border-border bg-surface px-3 py-2 text-sm font-semibold">Bütün PlayStation klubları</Link>
      ...
      <section className="mt-10 rounded-card border border-border bg-surface p-5">
        <h2 className="font-display text-lg font-bold">Ucuz PlayStation klubu necə seçmək olar?</h2>
        <p className="mt-2 text-sm leading-6 text-muted">Konsol modelini, otağın standart və ya VIP olmasını, saatlıq tarifi, gecə qiymətlərini və məkanın iş saatlarını müqayisə et. Bəzi klublarda PS5 qiyməti PS4-dən yüksək olur, buna görə minimum qiymətlə yanaşı tarifin hansı konsola aid olduğuna da bax.</p>
      </section>
    </div>
  );
}
